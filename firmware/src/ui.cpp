...
void build_home_screen() {
    ...
    lv_obj_align(temp_label, LV_ALIGN_TOP_RIGHT, -50, 8);
    ...
    lv_obj_align(battery_label, LV_ALIGN_TOP_RIGHT, 0, 8);
    ...
    lv_line_set_points(header_line_1, line_points_1, 2); // Set the points of the line
    lv_obj_set_style_line_color(header_line_1, lv_color_black(), 0);
    lv_obj_set_style_line_width(header_line_1, 1, 0);
    lv_obj_align(header_line_1, LV_ALIGN_TOP_MID, 0, 32);

    lv_obj_t *vertical_line = lv_line_create(screen);
    static lv_point_precise_t vertical_points[] = {{0, 0}, {0, 288}};
    ...
    lv_obj_align(vertical_line, LV_ALIGN_TOP_MID, 0, 32);
    ...
    lv_obj_set_style_line_width(right_split_line, 1, 0);
    lv_obj_align(right_split_line, LV_ALIGN_TOP_RIGHT, 0, 176);

    // ---- SPEED (big number, left side) ----
    ...
    lv_obj_align(speed_label, LV_ALIGN_LEFT_MID, -60, -40);
    ...
    lv_obj_align(unit_label, LV_ALIGN_LEFT_MID, -60, 30);
    ...
    lv_obj_align(distance_title, LV_ALIGN_TOP_RIGHT, -50, 50);
    ...
    lv_obj_align(distance_label, LV_ALIGN_TOP_RIGHT, -50, 80);

    // ---- Time section (bottom right) ----
    ...
    lv_obj_align(time_title, LV_ALIGN_TOP_RIGHT, -50, 195);

    time_label = lv_label_create(screen);
    lv_label_set_text(time_label, "1:07:59");
    lv_obj_set_style_text_font(time_label, &lv_font_montserrat_20, 0);
    lv_obj_set_style_text_color(time_label, lv_color_black(), 0);
    lv_obj_align(time_label, LV_ALIGN_TOP_RIGHT, -50, 225);
}
...
void build_stats_screen () {
    ...
    lv_obj_set_style_text_font(temp_label_2, &lv_font_montserrat_14, 0); //Set font to Bank Gothic Demi 28
    lv_obj_set_style_text_color(temp_label_2, lv_color_black(), 0);
    lv_obj_align(temp_label_2, LV_ALIGN_TOP_RIGHT, -50, 8);
    ...
    lv_obj_align(battery_label_2, LV_ALIGN_TOP_RIGHT, 0, 8);
    ...
    lv_obj_align(header_line_2, LV_ALIGN_TOP_MID, 0, 32);
    ...
    lv_obj_align(middle_line, LV_ALIGN_TOP_MID, 0, 156);

    lv_obj_t *vertical_line_2 = lv_line_create(stats_screen);
    static lv_point_precise_t vertical_points_2[] = {{0, 0}, {0, 248}};
    ...
    lv_obj_align(vertical_line_2, LV_ALIGN_LEFT_MID, 0, 32);
    ...
    lv_obj_align(avg_title, LV_ALIGN_TOP_LEFT, 15, 50);
    ...
    lv_obj_align(avg_speed_label, LV_ALIGN_TOP_LEFT, 15, 80);
    ...
    lv_obj_align(avg_unit, LV_ALIGN_TOP_LEFT, 15, 115);
    ...
    lv_obj_align(max_title, LV_ALIGN_TOP_LEFT, 15, 150);
    ...
    lv_obj_align(max_speed_label, LV_ALIGN_TOP_LEFT, 135, 80);
    ...
    lv_obj_align(max_unit, LV_ALIGN_TOP_LEFT, 135, 115);
    ...
    lv_obj_align(elevation_title, LV_ALIGN_TOP_LEFT, 15, 170);
    ...
    lv_obj_align(elevation_label_stats, LV_ALIGN_TOP_LEFT, 15, 200);
    ...
    lv_obj_align(elevation_unit, LV_ALIGN_TOP_LEFT, 15, 235);
    ...
    lv_obj_align(calories_title, LV_ALIGN_TOP_LEFT, 135, 170);
    ...
    lv_obj_align(calories_label, LV_ALIGN_TOP_LEFT, 135, 200);
    ...
    lv_obj_align(calories_unit, LV_ALIGN_TOP_LEFT, 135, 235);
}
...
void add_screen_dots(lv_obj_t *screen, int active_index) {
    ...
    lv_obj_t *dot_1 = lv_obj_create(screen);
    lv_obj_set_size(dot_1, 10, 10);
    lv_obj_set_style_radius(dot_1, 5, 0);
    lv_obj_set_style_border_color(dot_1, lv_color_black(), 0);
    lv_obj_set_style_border_width(dot_1, 2, 0);
    lv_obj_align(dot_1, LV_ALIGN_BOTTOM_MID, -10, -5);

    if (active_index == 0) {
        lv_obj_set_style_bg_color(dot_1, lv_color_black(), 0);
    } else {
        lv_obj_set_style_bg_color(dot_1, lv_color_white(), 0);
    }

    lv_obj_t *dot_2 = lv_obj_create(screen);
    lv_obj_set_size(dot_2, 10, 10);
    lv_obj_set_style_radius(dot_2, 5, 0);
    lv_obj_set_style_border_color(dot_2, lv_color_black(), 0);
    lv_obj_set_style_border_width(dot_2, 2, 0);
    lv_obj_align(dot_2, LV_ALIGN_BOTTOM_MID, -10, -5);

    if (active_index == 1) {
        lv_obj_set_style_bg_color(dot_2, lv_color_black(), 0);
    } else {
        lv_obj_set_style_bg_color(dot_2, lv_color_white(), 0);
    }
